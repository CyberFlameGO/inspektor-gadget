...
WARN[0000] connect to gadget service on node "minikube-m02": context canceled
NODE                             OUTPUT
minikube                         Attaching 1 probe...
...
We plan to make the bpftrace and Inspektor Gadget more powerful in the future. Please check TODO
issue that contains more details about the planned features.
